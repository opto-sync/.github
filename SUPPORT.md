...
Planning context for the GitHub owner is tracked in [github.com/opto-sync](https://linear.app/denman/project/githubcomopto-sync-de6ba65bd559), although external contributors may not have access. Repository-local support documentation may define a narrower channel or support policy.
