...
- [GitHub Project: opto-sync-project](https://github.com/orgs/opto-sync/projects/1)
- [Linear planning project](https://linear.app/denman/project/githubcomopto-sync-de6ba65bd559)
...
This GitHub account maintains software, infrastructure, research, and supporting documentation under the [`opto-sync`](https://github.com/opto-sync) GitHub owner.

Planning and delivery context is tracked in [github.com/opto-sync](https://linear.app/denman/project/githubcomopto-sync-de6ba65bd559). Public contribution, security, and governance defaults are maintained in [`.github`](https://github.com/opto-sync/.github).
