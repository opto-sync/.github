...
- Organization defaults: https://github.com/opto-sync/.github
- Canonical agent policy: https://github.com/opto-sync/.github/blob/main/agents.md
- Security policy: https://github.com/opto-sync/.github/security/policy
...
`opto-sync` declares repository roles, dependency edges, cross-organization capabilities, deployment ownership, and the git-submodule/Zed-package contract:
